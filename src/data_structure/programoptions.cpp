...
OptionDouble ProgramOptions::sloOverlayAlpha   (0.7  , "sloOverlayAlpha"     , "ProgramOptions", 0.0, 1.0, 0.1);
...
OptionBool   ProgramOptions::layerSegHighlightSegLine    (true      , "HighlightSegLine", "LayerSeg");
